    ...
    <>
      <Col>
        ...
        >
          <Col span={24}>
            <br />
            <div className="info-header">interplanetary company</div>
            <div className="info-content">All things interplanetary</div>
            <br />
            <div className="info-header">objects created</div>
            {artworkGrid}
          </Col>
        </Row>
      </Col>
